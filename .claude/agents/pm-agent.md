...
Route to `management-status-update` for Thai-first, evidence-backed status-update drafts (Boss, Leadership, team, or defect updates for GitHub, Slack, standup, email, or meetings) — communication drafts only, never a replacement for a formal engineering artifact or an external post.
