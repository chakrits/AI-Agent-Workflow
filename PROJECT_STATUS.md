...
- Issue #212 (IMP-006): design decided (ADR-0021, see Completed entry for Issue #229) and `status:spec-ready` applied, but AC-02 through AC-04 and AC-06 through AC-08 remain unimplemented — the parity script itself, the actual `role-definitions.md` relocation edit plus `npm run repin:source-matrix`, adapter wiring, and the Release Agent skill. Next step: dispatch Developer Agent.
