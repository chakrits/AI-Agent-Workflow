...
| Risks / Limitations | Documented | Historical GitHub manual-rerun limitation is superseded by PRs #23 and #24; GitLab has no API enforcement without approved credentials. |
