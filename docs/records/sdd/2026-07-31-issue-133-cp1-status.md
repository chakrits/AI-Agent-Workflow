...
- Foundation gate: the frozen Node 22 Linux/macOS/Windows and Python 3.12 JCS-reference matrix remains required evidence. Any later proposal to narrow supported hosts requires a separate Human decision before hosted activation; it does not silently narrow foundation acceptance.
