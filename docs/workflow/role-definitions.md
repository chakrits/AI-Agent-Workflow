...
See [`docs/workflow/task-execution-mode.md`](task-execution-mode.md#terminal-dispatch-and-boss-visibility) for the Orchestrator's terminal-dispatch outcomes, dispatch-receipt states, Boss-visible event requirements, and in-turn supervision contract.
